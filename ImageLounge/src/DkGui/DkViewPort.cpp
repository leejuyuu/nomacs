...
void DkViewPort::connectLoader()
{
    ...
    connect(vm, &DkViewPortFSViewModel::imageIndexChanged, mController->getFilePreview(), &DkFilePreview::setFileIndex);
    ...
    connect(mController->getScroller(), &DkFolderScrollBar::loadFileSignal, vm, &DkViewPortFSViewModel::loadFileAt);
